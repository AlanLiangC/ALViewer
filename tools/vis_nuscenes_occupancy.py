...
def vis_nuscene():
    ...
    file = r"/home/alan/AlanLiang/Datasets/Nuscenes/occupancy/scene-0001/0037a705a2e04559b1bba6c01beca1cf/labels.npz" # change this to the file path on your machine
    data = np.load(file)
