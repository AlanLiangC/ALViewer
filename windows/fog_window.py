...
from fog_simulation.fog_simulation import ParameterSet, RNG, simulate_fog
...
parser.add_argument('-d', '--datasets', type=str, help='path to where you store your datasets',
                    default=str(Path.home() / 'AlanLiang/Datasets'))
...
KITTI = DATASETS_ROOT / 'KITTI/kitti/training/velodyne'
